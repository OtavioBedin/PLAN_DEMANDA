...
set "ARQUIVO_IPYNB=03_KRONA_DESAGREGAR_GERAR_PLANO_PROD.ipynb"
set "ARQUIVO_PY=03_KRONA_DESAGREGAR_GERAR_PLANO_PROD.py"

echo.
echo ============================================================
echo DESAGREGACAO E GERACAO DO PLANO DE PRODUCAO
echo ============================================================
echo.
echo Pasta raiz:
echo %PASTA_RAIZ%
