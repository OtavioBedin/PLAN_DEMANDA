...
set "ARQUIVO_IPYNB=06_KRONA_ORCAMENTO_DESAGREGAR_PLANO.ipynb"
set "ARQUIVO_PY=06_KRONA_ORCAMENTO_DESAGREGAR_PLANO.py"

echo.
echo ============================================================
echo EXECUCAO DA DESAGREGACAO DO PLANO DE ORCAMENTO
echo ============================================================
echo.
echo Pasta raiz:
echo %PASTA_RAIZ%
